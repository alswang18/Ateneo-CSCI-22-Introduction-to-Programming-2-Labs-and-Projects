 ...
 * This is the class that contains components such as JFrame, JButton, etc, that make up the skeleton of the GUI. THis is where all the buttons and interactions with the program is setup.
 *
 * @author Alec Wang
